...
for _,mode in ipairs({"on", "off"}) do
    ...
    if on then
        ...
        box = {
            ...
            --{ 0.48, -0.5,-0.5,  0.5,  1.5, 0.5}, -- left
            {-0.5 , -0.5, 0.48, 0.48, 1.5, 0.5}, -- back
            --{-0.5,  -0.5,-0.5 ,-0.48, 1.5, 0.5}, -- right

            { -0.5,-0.5,-0.5,  0.5,-0.48, 0.5}, -- floor
            { -0.5, 1.45,-0.5,  0.5, 1.5, 0.5}, -- ceil
        }
        cbox = table.copy(box)
...
local box = {
    ...
    { -0.5, -0.5, 0.48,  0.48, 1.5, 0.5}, -- back
    --{ -0.5, -0.5, -0.5,  -0.48, 1.5, 0.5}, -- right
    --{ -0.5, -0.5, -0.48,  0.5, 1.5, -0.5}, -- front
